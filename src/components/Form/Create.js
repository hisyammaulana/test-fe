    ...
    <div>
      <div className="bg-white rounded-lg flex flex-col w-full mt-10 md:mt-0 relative z-10">
        ...
        <form>
          ...
          <div className="flex">
            <button className="flex ml-auto text-black bg-white border-0 py-2 px-6 focus:outline-none shadow-lg rounded">
              Cancel
            </button>
            <button className="inline-flex text-white bg-cyan-700 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded-lg text-sm cursor-pointer">
              Save Task
            </button>
          </div>
        </form>
